package org.example.telgrambotaiassistant.keyboard;

import org.example.telgrambotaiassistant.catalog.WheelCatalogItem;
import org.example.telgrambotaiassistant.handler.CallbackAction;
import org.example.telgrambotaiassistant.handler.MenuText;
...
public class KeyboardFactory {
    ...
    public InlineKeyboardMarkup resultsInline() {
        return inlineRows(List.of(
                List.of(button("Назад", CallbackAction.BACK_RESULTS))
        ));
    }
