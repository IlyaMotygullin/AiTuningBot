package org.example.telgrambotaiassistant.text;
...
public final class BotMessages {
    ...
    public static final String PREMIUM_ACTIVE = """
            👑 Premium активен

            Осталось: 23 дня

            Продление — скоро в этом разделе.""";
    ...
    public static final String RESULTS_SAMPLE = """
            BMW M4
            RAYS TE37
            27.05.2026
    ...
    public static final String NO_ATTEMPTS = """
            У вас закончились попытки, пополните баланс

            Оформите Premium для безлимитных генераций.""";
